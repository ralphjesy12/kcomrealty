...
class AjaxController extends Controller {
    ...
    */
	...
	public function getUnitData($input)
	{
		$ajax = [];
		include 'Ajax/getUnitData.php';
		return $ajax;
	}

	public function addUnitImage($input){
		$ajax = [];
		include 'Ajax/addUnitImage.php';
		return $ajax;
	}
	public function removeUnitImage($input){
		$ajax = [];
		include 'Ajax/removeUnitImage.php';
		return $ajax;
	}
